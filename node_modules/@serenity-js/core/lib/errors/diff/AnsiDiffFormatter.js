...
class AnsiDiffFormatter {
     ...
     * @param chalkOptions
     */
    constructor(chalkOptions) {
        this.chalk = new chalk_1.Instance(chalkOptions);
    }
    expected(line) {
...
exports.AnsiDiffFormatter = AnsiDiffFormatter;
//# sourceMappingURL=AnsiDiffFormatter.js.map
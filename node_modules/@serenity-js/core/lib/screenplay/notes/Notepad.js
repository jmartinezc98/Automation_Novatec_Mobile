 ...
 * @group Notes
 */
class Notepad extends tiny_types_1.TinyType {
    recordedNotes;
    /**
    ...
    get(subject) {
        if (!this.has(subject)) {
            throw new errors_1.LogicError((0, io_1.d) `Note of ${subject} cannot be retrieved because it's never been recorded`);
        }

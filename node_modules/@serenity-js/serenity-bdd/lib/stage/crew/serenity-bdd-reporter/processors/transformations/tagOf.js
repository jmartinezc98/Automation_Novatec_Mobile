...
function tagOf(tag) {
    return (context) => (0, tiny_types_1.match)(tag)
        ...
        const featureTag = {
            ...tagReportFor(tag),
            name: join('/', ...displayNamesOfRecorded(model_1.ThemeTag, context.report.tags), displayNameOfRecorded(model_1.CapabilityTag, context.report.tags), tag.name),
            displayName: tag.name,
        };
...
function displayNamesOfRecorded(typeOfTag, tags) {
